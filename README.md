...
- **A status strip.** The dock shows the machine's tmux sessions, network rate, processor, memory and battery before its name; a click attaches to a session or opens btop or htop. Settings takes it away.
